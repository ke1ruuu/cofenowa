          ...
          <div className="flex items-center gap-3">
            {user && (
              <div className="hidden lg:flex items-center gap-2 px-4 py-2 rounded-xl bg-[#f27f0d]/5 border border-[#f27f0d]/10 mr-2">
                ...
                <span className="text-xs font-black text-[#f27f0d]">
                  450 PTS
                </span>
              </div>
            )}
            ...
            {user ? (
              ...
              <>
                <Link href="/login" className="hidden sm:block">
                  <Button className="cursor-pointer h-11 bg-[#f27f0d] hover:bg-[#f27f0d]/90 rounded-xl px-6 font-black transition-all active:scale-95 shadow-lg shadow-[#f27f0d]/20">
                    Login
                  </Button>
                </Link>
                <Link href="/login?mode=signup" className="hidden sm:block">
                  <Button className="cursor-pointer h-11 bg-[#181411] hover:bg-[#181411]/90 rounded-xl px-6 font-black transition-all active:scale-95 shadow-lg shadow-[#f27f0d]/20">
                    Sign Up
                  </Button>
                </Link>
              </>
