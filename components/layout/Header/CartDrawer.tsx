...
export function CartDrawer({ isOpen, onClose, user }: CartDrawerProps) {
  const {
    cart,
    totalItems,
    totalPrice,
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-[10px] uppercase tracking-wider text-[#8a7560] leading-relaxed">
                          {item.size}
                          {item.addonDisplay ? ` • ${item.addonDisplay}` : ""}
                        </p>
                      </div>
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      <div className="flex items-center gap-3 rounded-lg bg-[#f8f7f5] p-1 border border-[#f2ede8]">
                        <button
                          ...
                          className={`flex h-6 w-6 items-center justify-center rounded bg-white shadow-sm border border-[#e6e0db] transition-opacity ${item.quantity <= 1 ? "opacity-30 cursor-not-allowed" : "hover:bg-gray-50"}`}
                        >
                        ...
                        <button
                          ...
                          className="flex h-6 w-6 items-center justify-center rounded bg-white shadow-sm border border-[#e6e0db] hover:bg-gray-50"
                        >
